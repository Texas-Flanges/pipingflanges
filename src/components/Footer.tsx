      ...
      <div className="container-wide">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
<li><a href="https://ansiflange.com" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition">ANSI Flanges</a></li>
<li><a href="https://carbonflanges.com" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition">Carbon Flanges</a></li>
<li><a href="https://industrialflange.com" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition">Industrial Flanges</a></li>
